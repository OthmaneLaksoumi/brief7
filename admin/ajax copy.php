...
<body>
    ...
    <script>
        ...
        function nbrOfCatg(catg) {
            let result = 0;
            products.forEach(function(obj) {
                if (obj['catg'] === catg) result++;
            });
            return result;
        }
        ...
        /* Debut Pagination */
        let itemsPerPage = 2;
        let nbrOfPages = Math.ceil(nbrOfCatg("Afficheur") / itemsPerPage);
        ...
        allListNbr.forEach(function(list) {
            list.addEventListener('click', function() {
                ...
                products.forEach(function(obj, i) {
                    if (counter < itemsPerPage && i >= (nbr - 1) * itemsPerPage && i < (nbr - 1) * itemsPerPage + itemsPerPage) {
                        if (obj['catg'] === 'Afficheur') {
                            displayProducts(obj);
                            counter++;
                        }
